 ...
 * @author Jacob-MTech
 */
public class IntentionalSnakes_b3_stable extends JFrame {

    SnakePanel sP;

    public IntentionalSnakes_b3_stable() throws InterruptedException {
        super("CrazySnakes");
        setSize(500, 500);
        sP = new SnakePanel();
        add(sP);
    ...
    public static void main(String[] args) throws InterruptedException {
        IntentionalSnakes_b3_stable s = new IntentionalSnakes_b3_stable();
